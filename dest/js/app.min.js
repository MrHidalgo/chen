...
/*!**************************************!*\
  ...
  \**************************************/function(e,n,t){t.r(n);var a={init:function(){$(".about__nav a").on("click",(function(e){var n=$(e.currentTarget),t=n.attr("data-id");n.hasClass("is-active")||($(".about__block").hide(),$('.about__block[data-block-id="'+t+'"]').css("display","grid"),$(".about__nav a").removeClass("is-active"),n.addClass("is-active"))}))}};n.default=a},"./src/js/macros/hamburgerMenu.js":
/*!****************************************!*\
